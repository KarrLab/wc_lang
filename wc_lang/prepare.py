...
class PrepareModel(object):
    ...
    Currently added data:
        ...
        * Identify gaps in dFBA submodel reaction networks
        ...
        for submodel in self.model.get_submodels():
            if submodel.algorithm == SubmodelAlgorithm.dfba:
                ...
                warn("{} exchange reactions created for submodel '{}'.".format(reactions_created,
                    submodel.name))
                '''
                reaction_gaps = self.identify_dfba_submodel_reaction_gaps(submodel)
                if reaction_gaps:
                    warn("{} gaps the reaction network for submodel '{}'.".format(len(reaction_gaps),
                        submodel.name))
                    for gap in reaction_gaps:
                        warn("{}".format(gap))
                '''
    ...
    def create_dfba_exchange_rxns(self, submodel, extracellular_compartment_id):
        ...
        * To represent FBA's mathematical assumption that it models a closed system, create
        ...
        # TODO:
        * To model how other pathways consume metabolites generated by metabolism, create 'implicit'
    ...
    def identify_dfba_submodel_reaction_gaps(self, submodel):
