...
class PrepareModel(object):
    ...
    def identify_dfba_submodel_rxn_gaps(self, submodel):
        ...
        all_dead_end_species = PrepareModel.find_dead_end_species(submodel, set())
        delta_dead_end_species = all_dead_end_species
        inactive_reactions = set()
        while any(delta_dead_end_species):
            inactive_reactions = PrepareModel.get_inactive_reactions(submodel, all_dead_end_species)
            tmp_not_consumed, tmp_not_produced = all_dead_end_species
            all_dead_end_species = PrepareModel.find_dead_end_species(submodel, inactive_reactions)
