...
class ParsedExpression(object):
    ...
    * The modeller is responsible for ensuring that units in expressions are internally consistent and appropriate
    ...
    Attributes:
        ...
        py_tokens (:obj:`list` of :obj:`collections.namedtuple`): a list of Python tokens generated by `tokenize.tokenize()`
    ...
    def eval(self, model,
        ...
        Approach:
            ...
            1. Replace references to used models in `self.wc_tokens` with values
            2. Join the elements of `self.wc_tokens` into a Python expression
