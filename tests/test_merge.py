...
class MergeTestCase(unittest.TestCase):
    ...
    def gen_models(self):
        ...
        # parameters
        models[0].parameters.create(id='p_0', units='s^-1')
        models[0].parameters.create(id='p_1', density_compartment=models[0].compartments[0], units='g l^-1')
        models[0].parameters.create(id='p_2', units='g l^-1')
        models[0].parameters.create(id='p_3', units='s^-1')
        models[0].parameters.create(id='p_4', density_compartment=models[0].compartments[1], units='g l^-1')

        models[1].parameters.create(id='p_0', units='s^-1')
        models[1].parameters.create(id='p_1', units='g l^-1')
        models[1].parameters.create(id='p_2', density_compartment=models[1].compartments[1], units='g l^-1')
        models[1].parameters.create(id='p_4', units='g l^-1')
        models[1].parameters.create(id='p_5', units='s^-1')
        models[1].parameters.create(id='p_6', units='s^-1')

        models[2].parameters.create(id='p_0', units='s^-1')
        models[2].parameters.create(id='p_1', density_compartment=models[2].compartments[0], units='g l^-1')
        models[2].parameters.create(id='p_2', density_compartment=models[2].compartments[2], units='g l^-1')
        models[2].parameters.create(id='p_3', units='s^-1')
        models[2].parameters.create(id='p_4', density_compartment=models[2].compartments[1], units='g l^-1')
        models[2].parameters.create(id='p_5', units='s^-1')
        models[2].parameters.create(id='p_6', units='s^-1')

        models[3].parameters.create(id='p_0', units='s^-1')
        models[3].parameters.create(id='p_1', density_compartment=models[3].compartments[0], units='g l^-1')
        models[3].parameters.create(id='p_2', density_compartment=models[3].compartments[2], units='g l^-1')
        models[3].parameters.create(id='p_3', units='s^-1')
        models[3].parameters.create(id='p_4', density_compartment=models[3].compartments[1], units='g l^-1')
        models[3].parameters.create(id='p_5', units='s^-1')
        ...
        # functions
        models[0].functions.create(id='sc_0', units='dimensionless')
        models[0].functions.create(id='sc_1', units='dimensionless')

        models[1].functions.create(id='sc_0', units='dimensionless')
        models[1].functions.create(id='sc_2', units='dimensionless')

        models[2].functions.create(id='sc_0', units='dimensionless')
        models[2].functions.create(id='sc_1', units='dimensionless')
        models[2].functions.create(id='sc_2', units='dimensionless')

        models[3].functions.create(id='sc_0', units='dimensionless')
        models[3].functions.create(id='sc_1', units='dimensionless')
        models[3].functions.create(id='sc_2', units='dimensionless')
    ...
    def test_merge_one_to_one(self):
        ...
        model_2.parameters.create(id='p_3', units='g l^-1')
        model_3.parameters.create(id='p_1', density_compartment=model_3.compartments[0], units='g l^-1')
        model_3.parameters.create(id='p_2', units='g l^-1')
        model_3.parameters.create(id='p_3', units='g l^-1')
        merged_model = model_1.copy()
        merged_model.merge(model_2.copy())
        self.assertTrue(merged_model.is_equal(model_3))
        merged_model = model_2.copy()
    ...
    def test_merge_one_to_one_errors(self):
        ...
        model_1.parameters.create(id='p_2', units='g l^-1')
        model_2.parameters.create(id='p_1', units='g l^-1')
        model_2.parameters.create(id='p_2', density_compartment=model_2.compartments[0], units='g l^-1')
        with self.assertRaisesRegex(ValueError, 'Cannot join'):
            model_1.copy().merge(model_2.copy())
        with self.assertRaisesRegex(ValueError, 'Cannot join'):
            model_2.copy().merge(model_1.copy())
